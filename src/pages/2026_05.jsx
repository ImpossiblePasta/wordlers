...
import { Icons } from '../assets/2026/may/icons';

import { colors, keys } from '../assets/2026/info.js';
import { scoreData, barData, pieData } from '../assets/2026/may/score.js';
import { playerData } from '../assets/2026/may/table.js';

import { lowestScore, lowestVarience, bestDay, leastMissed, highestImprovement, duoClosestScores, duoHighVar } from '../assets/2026/may/award.js';
      ...
      <div className='mainPage'>
        ...
        <div className='graphBox'>
            <LineGraph scoreData={scoreData} colors={colors} keys={keys} 
              dateString="MAY 2026" monthCode='MAY'
              minDate={new Date(2026, 5, 1)}
              maxDate={new Date(2026, 5, 31)}
              />

            <BarGraph scoreData={barData} colors={colors} keys={keys} 
              dateString="2026 YEAR TOTAL" monthCode='MAY' months={5}/>
              
            <PieGraph pieData={pieData} dateString="MAY 2026"/>
        </div> }
        ...
        { hash == 'data' &&
          <div className='dataBox'>
              <ExpandingTable dataSet={playerData} date='MAY 2026 DATA'/>
              {/* BELOW THE DATA TABLE HAVE A DOWNLOAD BUTTON */}
              <ThemeProvider theme={theme}>
                <Button variant="contained" 
                  href={'https://www.dropbox.com/scl/fi/wea91l6i36tl9hx7qsexf/WORDLERS_may2026.xlsx?rlkey=ye323s64wais2wgqcb2bktsow&st=m1ev0mm0&dl=1'} 
                  download="WORDLERS_2026_05.xlsx"
                  // target="_blank"
